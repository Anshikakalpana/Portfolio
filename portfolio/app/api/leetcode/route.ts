...
//           totalSolved: user.totalSubmissionNum.count,
//           totalsubmissions: user.totalSubmissionNum.submissions,
  ...
  try {
    if (session) {
      ...
      return NextResponse.json({
        ...
        data: {
          username: user.username,
          totalSolved: user.submitStats.totalSubmissionNum.find((d: any) => d.difficulty === "All")?.count,
          totalSubmissions: user.submitStats.totalSubmissionNum.find((d: any) => d.difficulty === "All")?.submissions,
          stats: user.submitStats.acSubmissionNum,
          streak: user.userCalendar.streak,
          totalActiveDays: user.userCalendar.totalActiveDays,
          heatmap: submissionCalendar,
