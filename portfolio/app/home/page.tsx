    ...
    <div className="min-h-screen bg-black flex flex-col">
      ...
      <section className="flex justify-center items-center text-center flex-grow px-6 md:px-32 pt-16">
        <div className="max-w-4xl">
          ...
          <p className="text-gray-300 text-lg md:text-xl leading-relaxed tracking-wide font-medium mb-10">
            I possess a strong foundation in <span className="font-semibold text-white">Data Structures and Algorithms</span>, 
